...
| `primary_author` | | chr | The author or authors who published the scientific name | | — | — | — |
| `publication_author` | | chr | The author or authors of the book... | | `publicationAuthor` | `publicationAuthor` | Pub. Author |
| `replaced_synonym_author`| | chr | The author or authors responsible for publication of the replaced synonym | | — | — | — |
| **PUBLICATION** | | | | | | | |
...
| `parent_plant_name_id` | | chr | ID for the parent genus or parent species | | — | — | — |
| `homotypic_synonym` | | logical | TRUE if homotypic synonym | | — | — | — |
